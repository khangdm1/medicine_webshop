                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://hoidanit.vn" target="_blank">
                                <h1 class="text-primary mb-0">Nhà thuốc DKK</h1>
                                <p class="text-secondary mb-0">@dkk</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author: DKK</p>
                            <p>Website: <a href="#" target="_blank"> dkk.vn</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>DKK</a>, All right
                            reserved.</span>
                    </div>
